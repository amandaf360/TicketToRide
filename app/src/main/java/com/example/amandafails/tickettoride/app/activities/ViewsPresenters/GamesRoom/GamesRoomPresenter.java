...
public class GamesRoomPresenter implements IGamesRoomPresenter, Observer
{
    ...
    private void doit()
    {
        ...
        if(createGame)
        {
            ...
            createGameService.createGame(clientModel.getUser().getUserName(), value + 2, makeGameName(), clientModel.getUser().getAuthToken()); // FIX HERE FOR GAME CREATION (value + 2 instead of value + 1)

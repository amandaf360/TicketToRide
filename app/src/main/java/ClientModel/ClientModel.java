...
public class ClientModel extends Observable
{
    ...
    public void initializeRoutes()
    {
        if(routes.size() == 0)
        {
            routes.add(new Route(0, 0, 0, 5, "red", "none", "Helena-Omaha"));
            routes.add(new Route(0, 0, 0, 3, "red", "none", "SaltLakeCity-Denver"));
            routes.add(new Route(0, 0, 0, 3, "yellow", "none", "SaltLakeCity-Denver"));
            routes.add(new Route(0, 0, 0, 4, "red", "none", "Denver-OklahomaCity"));
